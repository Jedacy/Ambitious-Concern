...
const Latest = () => {
  return (
    <div className="pt-10 pb-44 mb-80 bg-steps_to_take bg-cover relative">
        ...
        <div className="container mx-auto overflow-y-scroll flex gap-4 md:gap-10 border-b-8 bg-white border-primary py-10 justify-between absolute top-[400px] md:top-[350px] left-1/2 -translate-x-1/2 -translate-y-1/2">

            <div className="flex flex-col gap-3 md:gap-5 items-center justify-center min-w-60 md:min-w-0">
                <div>
                    <img src="/services_images/icon container.png" alt="" className="w-24 md:w-auto"/>
                </div>
                
                <h2 className="font-Ronoto-Slab font-extrabold text-heading text-lg md:text-xl">Take Action</h2>
                <p className="max-w-[25ch] text-center font-Poppins text-sm md:text-base">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            </div>
            <div className="flex flex-col gap-3 md:gap-5 items-center justify-center min-w-60 md:min-w-0">
                <div>
                    <img src="/services_images/icon container.png" alt="" className="w-24 md:w-auto"/>
